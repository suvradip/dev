        ...
        "beforeInitialize": function(evtObj, argObj) {
            ...
            getDataFromChart = function() {
                var i,
                    ...
                    dataArr,
                    flagData = false,
                    objDataset = FusionCharts("chartId").getJSONData && FusionCharts("chartId").getJSONData().dataset;
                //Form tabular string
                str = '<div style="margin: 3px"> Data is returned by the chart as Array. The data is converted into tabular format using JavaScript.</div>';
                ...
                for (i in objDataset) {
                    ...
                    if (dataArr.length > 0) {
                        flagData = true;
                        str += '    <tr>';
                        str += '        <td width="20%" class="fontBold valueFont" color="' + objDataset[i].color + '">' + objDataset[i].seriesname + '</td>';
                        ...
                        ds += '<td width="40%" class="fontBoldSmall"> Price (in USD)</td>';
                        ds += '<td width="40%" class="fontBoldSmall"> Quantity Sold</td>';
                        ds += '</tr>';
                        for (j = 0; j < dataArr.length; j++) {
                            ds += '<tr>';
                            ds += '<td width="20%" align="center">' + dataArr[j].id + '</td>';
                            ds += '<td width="40%" align="center"> ' + dataArr[j].x + '</td>';
                            ds += '<td width="40%" align="center">' + dataArr[j].y + ' units</td>';
                            ds += '</tr>';
                        }
                        ds += '</table>';
                        str += '        <td width="80%" class="valueFont">' + ds + '</td>';
                        str += '    </tr>';
                    }
