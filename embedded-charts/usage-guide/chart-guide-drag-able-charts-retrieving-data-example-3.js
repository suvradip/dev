$(function() {var chart = new FusionCharts({
    ...
    events: {
        'beforeRender': function(evt, arg) {
            ...
            controllers.innerHTML = "<div id='tableCont' style='width:500px;margin:10px'><table id='data-table' style='margin: 5px auto;border-collapse: collapse;border: 1px solid;border-bottom: 2px solid #6baa01;width:500px'></table></div>";
