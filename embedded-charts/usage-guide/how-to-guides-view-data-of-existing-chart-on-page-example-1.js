$(function() {var chart = new FusionCharts({
    ...
    events: {
        ...
        'renderComplete': function(evt, args) {
            ...
            var td = '<td style="padding:5px; text-align:center; border:1px solid black; background-color:#f0f0f0; font-size:11px;">';
            ...
            document.getElementById('table-container').innerHTML = '<table width ="500px;"><tbody>' + tableHeader + tableBody + '</tbody</table>';
        }
    }
}
