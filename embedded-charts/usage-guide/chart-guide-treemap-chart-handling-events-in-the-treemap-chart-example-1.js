    ...
    "events": {
        'beforeRender': function(evt, args) {
            if (!document.getElementById('eventmessages')) {
                ...
                paraText.innerHTML = "Invoked Event gets displayed below.";
                var controllers = document.createElement('div');
                controllers.setAttribute('id', 'eventmessages');
                controllers.innerHTML = "";

                args.container.parentNode.insertBefore(controllers, args.container.nextSibling);
                args.container.parentNode.insertBefore(paraText, controllers);
                // set css style for controllers div
                controllers.style.cssText = 'position:inherit; width:67%; height: 100px; border: 1px solid #cccccc; margin-top:10px;padding-left:5px; overflow: auto;';
            }
        ...
        'drillDown': function(evt, args) {
            document.getElementById('eventmessages').innerHTML = " Event - <b> drillDown </b> invoked<br>" + document.getElementById('eventmessages').innerHTML;
        },
        ...
        'drillUp': function(evt, args) {
            document.getElementById('eventmessages').innerHTML = " Event - <b> drillUp </b> invoked<br>" + document.getElementById('eventmessages').innerHTML;
        }
    }   
